...
<table align="center" border="1" width="400px">
    ...
    <tr>
    	<th>年龄</th>
        <td><input id="4" type="text" name="age" value="${contact.age }"/><font color="red">${msg4 }</td>
    </tr>
    <tr>
    	<th>邮箱</th>
        <td><input id="5" type="text" name="email" value="${contact.email }"/><font color="red">${msg5 }</td>
    </tr>
    <tr>
    	<th>QQ</th>
        <td><input id="6" type="text" name="qq" value="${contact.qq }"/><font color="red">${msg6 }</td>
    </tr>
